...
export HBASE_ROOT_LOGGER="DEBUG,RFA"

# The java implementation to use. Java 1.6 required.
export JAVA_HOME=/usr/lib/jvm/jdk1.8.0_102

# HBase Configuration directory
export HBASE_CONF_DIR=${HBASE_CONF_DIR:-/usr/hdp/current/hbase-master/conf}
...
export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS -Xmn1072m -XX:CMSInitiatingOccupancyFraction=70  -Xms3584m -Xmx3584m $JDK_DEPENDED_OPTS"
